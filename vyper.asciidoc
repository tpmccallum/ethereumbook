...
These and other vulnerabilities, are introduced into the smart contracts via code. It can be strongly argued that these vulnerabilities were not intentionally introduced. Nevertheless, they have still resulted in the catastrophic loss of funds for Ethereum users.
